...
export const versionHistory = [
  ...
  },
  {
    ...
    date: "2026-09-22",
    changes: [
      "Kundenauswahlen zeigen Firmenname und Ansprechpartner gemeinsam statt Firmen unter Personennamen zu verstecken",
      "Projekt-, Objekt-, Auftrags-, Onboarding- und Lagerauswahlen verwenden dieselbe eindeutige Kundenanzeige",
    ],
  },
  {
    version: "1.423.0",
  ...
  },
  {
    ...
    date: "2026-09-13",
    changes: [
      "Berichtsfotos in der Auswertung zaehlen nur noch eindeutige Fotos aus Einsatzberichten",
      "Wochenberichte werden bei der Foto-Kennzahl nicht mehr doppelt mitgezaehlt",
    ],
  },
  {
    version: "1.411.0",
    date: "2026-09-13",
    changes: [
      "Auswertungsrapporte koennen als PDF heruntergeladen werden",
      "Kunden- und Objektauswertungen koennen an den Kunden gesendet werden",
      "Mitarbeiterauswertungen koennen an den jeweiligen Mitarbeiter gesendet werden",
    ],
  },
  {
    version: "1.410.0",
  ...
  },
  {
    ...
    date: "2026-09-13",
    changes: [
      "Auswertungsfilter stehen kompakt links mit Zeitraumfeldern rechts daneben",
      "Monat, Kalenderwoche und freier Zeitraum koennen per Pfeil vor und zurueck geschaltet werden",
      "Kennzahlenkarten in der Auswertung zeigen Ueberschrift und Wert zentriert",
    ],
  },
  {
    version: "1.407.0",
    date: "2026-09-13",
    changes: [
      "Die obere Kennzahlen-Quickbar wird nur noch im Dashboard angezeigt",
    ],
  },
  {
    version: "1.406.0",
  ...
  },
  {
    ...
    date: "2026-09-13",
    changes: [
      "Fahrtenbuch sortiert Fahrten am gleichen Tag nach Start-KM und Startzeit statt nur nach Datum",
      "Automatische Vollsyncs und Positionsupdates werden bei laufenden Klicks, Touchs und Formulareingaben kurz zurueckgestellt",
    ],
  },
  {
    version: "1.402.0",
  ...
  },
  {
    ...
    date: "2026-09-13",
    changes: [
      "Berichtsbereich heisst nun Arbeiten vor Ort statt Kontrolle vor Ort",
    ],
  },
  {
    version: "1.395.0",
    date: "2026-09-13",
    changes: [
      "Bericht-Mail und PDF weisen auf kleine Vorschaubilder hin und nennen den Kundenportal-Link fuer Bilder in voller Qualitaet",
    ],
  },
  {
    version: "1.394.0",
  ...
  },
  {
    ...
    date: "2026-09-13",
    changes: [
      "Berichtsfoto-Wiederherstellung prueft zuerst den aktuellen mobilen Arbeitsstand und liest Backups nur noch als Fallback",
    ],
  },
  {
    version: "1.392.0",
    date: "2026-09-13",
    changes: [
      "Berichtsfoto-Wiederherstellung nutzt zusaetzlich den mobilen Arbeitsstand, wenn Fotos im fertigen Bericht fehlen",
    ],
  },
  {
    version: "1.391.0",
  ...
  },
  {
    ...
    date: "2026-09-12",
    changes: [
      "Kunden, Objekte, Personal und Auftraege sind an den kleinen Sync angebunden und werden zusaetzlich in eigenen Tabellen gelesen und gespeichert",
      "Auftragsanlage und Stammdaten-Aenderungen muessen dadurch nicht mehr den kompletten App-State bewegen",
      "Der alte Gesamtzustand bleibt als Fallback aktiv, waehrend die App schrittweise voll relational wird",
    ],
  },
  {
    version: "1.379.0",
  ...
  },
  {
    ...
    date: "2026-09-09",
    changes: [
      "Mobil-vor-Ort-Aufgaben werden beim Oeffnen nicht mehr automatisch abgehakt",
      "Die Option Zeit im Bericht anzeigen wird als schlichte Checkbox-Zeile ohne umrandeten Eingabeblock dargestellt",
    ],
  },
  {
    version: "1.343.0",
  ...
  },
  {
    ...
    date: "2026-09-06",
    changes: [
      "Neue Texte in Dispokalender, Lagerverwaltung und Auswahl-Popups werden in der Sprachumschaltung nachgezogen",
      "Stammdaten enthalten einen Sprachen-Reiter mit Deutsch, Schwedisch und Englisch als Uebersetzungsdatei",
      "Der Dark Mode ist weicher abgestimmt und nicht mehr tiefschwarz",
    ],
  },
  {
    version: "1.327.0",
  ...
  },
  {
    ...
    date: "2026-09-06",
    changes: [
      "Die Materialauswahl in der Auftragsanlage zeigt nur noch die anklickbare Bestandsliste",
      "Das doppelte Material-Dropdown in der Auftragsanlage wurde entfernt",
    ],
  },
  {
    version: "1.322.0",
    date: "2026-09-06",
    changes: [
      "Inventur-PDF zeigt in der Mengenspalte nur noch die Differenz",
      "Der gezaehlte Inventurbestand wird in der Notizspalte ausgegeben",
    ],
  },
  {
    version: "1.321.0",
  ...
  },
  {
    ...
    date: "2026-09-05",
    changes: [
      "Lagerort-Bereich in der Lagerverwaltung ist einklappbar",
      "Lagerorte koennen ueber das Popup bearbeitet werden",
      "Das Wort Stammdaten wurde aus der Lagerort-Ueberschrift entfernt",
      "Artikel in der Lagerverwaltung koennen ueber ein Filterfeld durchsucht werden",
    ],
  },
  {
    version: "1.313.0",
  ...
  },
  {
    ...
    date: "2026-09-05",
    changes: [
      "Materialverwaltung enthaelt Lagerorte mit berechnetem Bestand pro Lagerort und gesamt",
      "Material-Ein- und Ausgaenge koennen mit Menge, Lagerort und Notiz gebucht werden",
      "Jedes Material zeigt eine Lagerhistorie mit einzelnen Buchungen",
      "Globale Menueleiste bietet einen direkten Einstieg in die Lagerverwaltung",
    ],
  },
  {
    version: "1.303.0",
    date: "2026-09-05",
    changes: [
      "Leistungskatalog wird in den Stammdaten als kompakte Liste statt als Kacheln dargestellt",
      "Pakete werden im Leistungsbereich ebenfalls als Liste angezeigt",
      "Listenansicht bleibt auch auf mobilen Bildschirmen geordnet",
    ],
  },
  {
    version: "1.302.0",
